...
outgroups = ["Villabruna", "Steppe_MLBA", "Israel_MLBA", 
             "Italy_Sardinia_EBA", "Tunisia_N",
             "Spain_LBA", "Italy_Sicily_EBA", "Greece_Minoan_Lassithi"] 
...
if __name__ == "__main__":
    ...
    for n in source_ns:
        output_folder = f"/n/groups/reich/hringbauer/git/punic_aDNA/output/qpAdm/comp2.v46.3/{n}way/"
