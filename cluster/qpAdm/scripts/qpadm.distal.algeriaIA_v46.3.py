...
path_iids = "/n/groups/reich/hringbauer/git/punic_aDNA/output/tables/qpadm.targets.distal.v46.3.tsv"
...
if __name__ == "__main__":
    ...
    for n in source_ns:
        output_folder = f"/n/groups/reich/hringbauer/git/punic_aDNA/output/qpAdm/distAlgIA.v46.3/{n}way/"
