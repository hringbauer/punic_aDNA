#!/bin/bash
########################################################
# bash script for fitting Western models using qpAdm.
...
# are set according to the Western model approach
# The final output files are:
#    All models:
#    %_OUTDIR%/qpAdm/westernModels/westernModels-all-models-with-p.tsv
#    Parsimonious models:
#    %_OUTDIR%/qpAdm/westernModels/westernModels-pars-models-with-p.tsv
########################################################
...
pvalThres=0.05
# reference (right) pops: 14 base pops + Levant_MLBA_source
references="ElMiron_back Mota_back Ust_Ishim_back Kostenki14_back GoyetQ116_back Vestonice16_back Villabruna_back WHG_back EHG_back CHG_back MA1_back Natufian_back Levant_N_back Tunisia_N_back Levant_MLBA_source"
# source (left) pops:
...
#######################################################
sources="Greece_BA_Myc_source Sicily_EMBA_source Steppe_MLBA_source Iberia_EBA_source Iran_N_source North_Africa_IA_source"
source $scriptDir/launch-batch-qpadm-runs.sh

#######################################################
#           Round 3 - all but Steppe                  #
#######################################################
sources="Greece_BA_Myc_source Sicily_EMBA_source Sardinia_LBA_source Iberia_EBA_source Iran_N_source North_Africa_IA_source"
source $scriptDir/launch-batch-qpadm-runs.sh

#######################################################
#           Round 4 - all but Iberia                  #
#######################################################
sources="Greece_BA_Myc_source Sicily_EMBA_source Steppe_MLBA_source Sardinia_LBA_source Iran_N_source North_Africa_IA_source"
source $scriptDir/launch-batch-qpadm-runs.sh

#######################################################
#           Round 5 - all but NorAf                   #
#######################################################
sources="Greece_BA_Myc_source Sicily_EMBA_source Steppe_MLBA_source Sardinia_LBA_source Iberia_EBA_source Iran_N_source"
source $scriptDir/launch-batch-qpadm-runs.sh

#######################################################
#           Round 6 - all but Sicily                  #
#######################################################
sources="Greece_BA_Myc_source Steppe_MLBA_source Sardinia_LBA_source Iberia_EBA_source Iran_N_source North_Africa_IA_source"
source $scriptDir/launch-batch-qpadm-runs.sh

#######################################################
#           Round 7 - all but Greece                  #
#######################################################
sources="Sicily_EMBA_source Steppe_MLBA_source Sardinia_LBA_source Iberia_EBA_source Iran_N_source North_Africa_IA_source"
source $scriptDir/launch-batch-qpadm-runs.sh

#######################################################
#           Round 8 - all but Iran                    #
#######################################################
sources="Greece_BA_Myc_source Sicily_EMBA_source Steppe_MLBA_source Sardinia_LBA_source Iberia_EBA_source North_Africa_IA_source"
source $scriptDir/launch-batch-qpadm-runs.sh

#######################################################
#           Round 9 - CenMed + NorAf                  #
#######################################################
